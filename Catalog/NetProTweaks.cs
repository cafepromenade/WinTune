...
public static class NetProTweaks
{
    public static IEnumerable<TweakDefinition> All() => new List<TweakDefinition>
    {
        ...
        Tweak.Powershell("net.adapters.route", "Routing table", "路由表",
        ...
        Tweak.Powershell("net.adapters.dnsclient", "DNS client settings", "DNS 客戶端設定",
        ...
        Tweak.Powershell("net.ipdns.get-serveraddress", "Get DNS servers", "查 DNS 伺服器",
            "List the configured DNS server addresses for each interface.", "列出每個介面所設定嘅 DNS 伺服器位址。",
            "Show", "顯示", "Get-DnsClientServerAddress | Format-Table -AutoSize",
        ...
        // --- firewall (20) ---
        Tweak.Powershell("net.firewall.show-all-profiles", "Show all profiles state", "顯示所有設定檔狀態",
        ...
        Tweak.Powershell("net.firewall.list-inbound", "List enabled inbound rules", "列出已啟用嘅入站規則",
        ...
        Tweak.Powershell("net.firewall.list-outbound", "List enabled outbound rules", "列出已啟用嘅出站規則",
        ...
        Tweak.Powershell("net.firewall.show-current-profile", "Show current active profile", "顯示目前作用中設定檔",
        ...
        Tweak.Powershell("net.firewall.list-blocked-apps", "List blocked program rules", "列出已封鎖程式規則",
        ...
        Tweak.Powershell("net.firewall.show-notifications", "Show notification setting", "顯示通知設定",
        ...
        Tweak.Powershell("net.firewall.show-log-path", "Show firewall log path", "顯示防火牆記錄路徑",
        ...
        Tweak.Powershell("net.firewall.list-by-group", "List rules grouped by group", "依群組列出規則",
        ...
        Tweak.Powershell("net.firewall.count-enabled", "Count enabled rules", "統計已啟用規則數量",
        ...
        Tweak.Powershell("net.diag.tcp-by-state", "TCP connections by state", "按狀態列 TCP 連線",
        ...
        Tweak.Powershell("net.diag.listening-ports", "Listening ports with process", "監聽埠連程序",
        ...
        Tweak.Powershell("net.diag.adapter-stats", "Network adapter usage", "網絡卡用量",
        ...
        Tweak.Powershell("net.diag.net-category", "Show network category", "顯示網絡類別",
